...
2. **Проверка введенных чисел на соответсвие условию**
Предположим,что введенное число не будет соответствовать условию
Необходимо рассмотреть два случая,когда введенные числа будут повторяться и если введенные числа будут вещественными
   1) 
4. **Сравнение чисел:**
 1 случай:
 х>y
